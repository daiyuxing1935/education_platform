...
from app.api.endpoints import auth, profile, profile_v2, chat, project, api_settings, ocr, files, question_bank, exam_paper, path, resources, video_resources, cloud_drive, code_execution, recommend, dashboard
