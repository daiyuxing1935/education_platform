...
class ErrorProneDomainData(BaseModel):
    domain_id: str = ""
    domain_name: str = ""
    topics: List[ErrorProneTopicData] = []


class ErrorProneSubjectData(BaseModel):
    subject_id: str = ""
    subject_name: str = ""
    domains: List[ErrorProneDomainData] = []
...
class DomainMasteryData(BaseModel):
    domain_id: str = ""
    domain_name: str = ""
    knowledge_points: List[KnowledgeMasteryData] = []


class SubjectMasteryData(BaseModel):
    subject_id: str = ""
    subject_name: str = ""
    domains: List[DomainMasteryData] = []


class ProfileResponse(BaseModel):
    student_id: str
    knowledge_mastery: List[SubjectMasteryData] = []
    cognitive_style: Optional[CognitiveStyleData] = None
    error_prone_topics: List[ErrorProneSubjectData] = []
