...
const features = [
  {
    ...
    title: '智能学习画像', desc: '通过练习记录与AI对话，自动构建多维学习画像，精准识别知识薄弱点与学习风格偏好。', color: '#818CF8', bg: 'rgba(129,140,248,0.12)', route: '/profile/dynamic',
  },
  {
    ...
    title: 'AI 多模态答疑', desc: '支持文字、代码、图像等多种形式的智能问答，即时解答学习中的疑问，如私人导师般耐心细致。', color: '#A78BFA', bg: 'rgba(167,139,250,0.12)', route: '/chat/new',
  },
  {
    icon: (<svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" /><polyline points="14 2 14 8 20 8" /><line x1="16" y1="13" x2="8" y2="13" /><line x1="16" y1="17" x2="8" y2="17" /><polyline points="10 9 9 9 8 9" /></svg>),
    title: '个性化资源生成', desc: 'AI根据你的学习进度与薄弱点，自动生成定制化的学习资料、练习题与知识总结。', color: '#93C5FD', bg: 'rgba(147,197,253,0.12)', route: '/recommendations',
  },
  {
    ...
    title: '自适应学习路径', desc: '设定学习目标，系统根据掌握度自动规划学习路径，并根据掌握程度动态调整学习计划。', color: '#FCD34D', bg: 'rgba(252,211,77,0.12)', route: '/path',
  },
  {
    ...
    title: '智能题库系统', desc: '海量题目资源，支持错题自动归类、薄弱知识点定向练习，让每一道题都练在刀刃上。', color: '#6EE7B7', bg: 'rgba(110,231,183,0.12)', route: '/banks',
  },
  {
    ...
    title: '学习数据分析', desc: '可视化的学习报告与知识掌握度分析，每日学习统计，帮助你科学规划学习时间。', color: '#F9A8D4', bg: 'rgba(249,168,212,0.12)', route: '/profile',
  },
]
...
export default function FeatureCards({ onLoginClick }: FeatureCardsProps) {
  ...
  return (
    <section id="features" style={{ padding: '100px 32px', background: '#0F172A' }}>
      <div style={{ maxWidth: 1200, margin: '0 auto' }}>
        ...
        <div className="anim-slide-up" ref={(el) => { if (el) setTimeout(() => el?.classList.add('visible'), 100) }} style={{ textAlign: 'center', marginBottom: '64px' }}>
          <span style={{ display: 'inline-block', padding: '4px 14px', borderRadius: '20px', background: 'rgba(99,102,241,0.15)', color: '#A5B4FC', fontSize: '0.8125rem', fontWeight: 600, marginBottom: '16px' }}>核心功能</span>
          ...
          {features.map((feature, i) => (
            <div key={feature.title} ref={(el) => { cardsRef.current[i] = el }}
              ...
              onMouseEnter={(e) => {
                ...
                e.currentTarget.style.boxShadow = `0 12px 32px -8px ${feature.color}33`
            ...
            >
              ...
              <h3 style={{ fontSize: '1.125rem', fontWeight: 600, color: '#F1F5F9', marginBottom: '10px', fontFamily: 'var(--font-heading)' }}>{feature.title}</h3>
              <p style={{ fontSize: '0.875rem', color: '#94A3B8', lineHeight: 1.7, margin: 0 }}>{feature.desc}</p>
            </div>
          ))}
        </div>
      </div>
