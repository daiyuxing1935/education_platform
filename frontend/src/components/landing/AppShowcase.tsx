...
export default function AppShowcase({ onLoginClick }: AppShowcaseProps) {
  ...
  return (
    <section id="showcase" ref={sectionRef} style={{ padding: '100px 32px', background: '#0B1121', borderTop: '1px solid #1E293B', borderBottom: '1px solid #1E293B' }}>
      <div style={{ maxWidth: 1200, margin: '0 auto' }}>
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '80px', alignItems: 'center' }} className="responsive-stack">

          {/* Left: Text Content */}
          <div ref={textRef} className="anim-slide-up" style={{ minWidth: 0 }}>
            <span style={{ display: 'inline-block', padding: '4px 14px', borderRadius: '20px', background: 'rgba(16,185,129,0.12)', color: '#6EE7B7', fontSize: '0.8125rem', fontWeight: 600, marginBottom: '16px' }}>产品介绍</span>
            <h2 style={{ fontSize: 'clamp(1.8rem, 3vw, 2.5rem)', fontWeight: 700, color: '#F1F5F9', letterSpacing: '-0.02em', marginBottom: '20px', fontFamily: 'var(--font-heading)', lineHeight: 1.3 }}>
            ...
            <button onClick={() => { if (isAuthenticated) navigate('/home'); else onLoginClick() }}
              className="btn-gradient" style={{ marginTop: '32px', padding: '14px 36px', fontSize: '1rem', borderRadius: '12px' }}>
              开始体验
          ...
          <div ref={previewRef} className="anim-slide-right" style={{ minWidth: 0 }}>
            <div style={{
              ...
              <div style={{ padding: '20px' }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px' }}>
                  ...
                  <div style={{ width: '60px', height: '24px', borderRadius: '6px', background: 'rgba(99,102,241,0.15)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '0.625rem', color: '#A5B4FC', fontWeight: 600 }}>AI对话</div>
                </div>
                ...
                <div style={{ borderRadius: '12px', border: '1px solid #334155', padding: '14px', marginBottom: '12px' }}>
                  ...
                  <div className="chat-bubble-1" style={{ padding: '10px 12px', borderRadius: '8px 8px 8px 2px', background: 'rgba(99,102,241,0.08)', fontSize: '0.75rem', color: '#CBD5E1', lineHeight: 1.6, marginBottom: '8px' }}>
                    根据你的学习画像，我发现你在「微积分-极限」部分掌握度较低（42%），建议先复习极限的基本概念...
                  </div>
                  <div className="chat-bubble-2" style={{ padding: '10px 12px', borderRadius: '8px 8px 2px 8px', background: '#1E293B', fontSize: '0.75rem', color: '#94A3B8', lineHeight: 1.6, textAlign: 'right', maxWidth: '70%', marginLeft: 'auto' }}>
                    好的，帮我生成几道练习题吧
                  </div>
                </div>
            ...
            <div style={{ textAlign: 'center', marginTop: '16px', fontSize: '0.8125rem', color: '#64748B' }}>
              <span style={{ background: '#1E293B', padding: '4px 16px', borderRadius: '20px', border: '1px solid #334155' }}>🖥 产品界面示意</span>
            </div>
          </div>
        </div>
      </div>
